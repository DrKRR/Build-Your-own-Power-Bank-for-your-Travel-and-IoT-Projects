...
The power bank shown above can be charged with any mobile chargers with micro USB2.0B termination. I used Motorola and Redmi mobile chargers (shown below) to successfully charge the power banks.
